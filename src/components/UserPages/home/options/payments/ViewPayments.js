...
import PaymentOptions from './PaymentTabs';
...
export default function ViewPayments(props) {
  ...
  return(
    ...
    id="panel1bh-header"
    >
    <Typography className={classes.heading}>My Payment History</Typography>
    {/* <Typography className={classes.secondaryHeading}>I am an expansion panel</Typography> */}
    </ExpansionPanelSummary>
    <ExpansionPanelDetails>
        <Box className={classes.settingOption}>
            <PaymentOptions userInfo={userInfo} setUserInfo={setUserInfo}/>
        </Box>
    </ExpansionPanelDetails>
</ExpansionPanel>
  )
